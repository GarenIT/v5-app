<template>
	...
	<view class="content">
		...
		<view class="mask" v-if="loading" style="background-color:#20202C;height:100%!important;" :style="{'margin-top':h5Top+'upx'}">
		...
		<view class="center-content">
			<view class="content-head">
				...
				<view class="username" v-if="info.username">{{info.username}}</view>
		...
		<view class="comment-bottom">
			<view class="comment-bottom-top">
				<text style="border-bottom:1px solid #999;padding-bottom:10upx;color:#FFFFFF;">全部评论 ({{commentCount}})</text>
			</view>
			<view class="comment-bottom-content">
				...
				<view class="send-comment">
					<input type="text" @input="setContent" :value="content" placeholder="我也来说几句" :maxlength="50" :cursor-spacing="10"/>
			       ...
			       //console.log(res.data);
					...
					if (imgList.length > 0) {
						for (var i = 0; i < imgList.length; i++) {
							//console.log(i)
							_self.imgList += '<img src="'+imgList[i]+'">';
						}
					}
