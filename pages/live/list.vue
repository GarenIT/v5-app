<template>
	...
	<view class="content">
		...
		<view class="center-content" :style="{'margin-top':contentTop+'px'}">
				...
				<view class="center-content-item" v-for="(m, i) in msgList" :key="i">
					<view class="center-top" @click="player(m)">
						...
						<view class="live-info my-info">
							...
							<view class="username">
								<image :src="m.head" mode="aspectFill" class="tx left" :style="{'margin-top':mTo+'upx'}"></image>
								<text>{{m.anchor}}</text>
			...
			<!-- #ifndef H5 -->
			<view style="width:100%;text-align:center;" :style="{'margin-top':(phone.windowHeight/2) - 200 +'px'}" v-if="isShowTig" @click="goSend">
				<image src="@/static/live/player.png" style="width:180upx;height:170upx;"></image>
				<view class="im-player">我要开直播</view>
			</view>
			<!-- #endif -->
			<!-- #ifdef H5 -->
			<view style="width:100%;text-align:center;" :style="{'margin-top':(phone.windowHeight/2) - 200 +'px'}" v-if="isShowTig">
				<image src="@/static/live/player.png" style="width:180upx;height:170upx;"></image>
			...
			<view class="popup-buy">
				...
				<view class="buy-btn">
					...
					<view class="btn right" v-if="buyInfo.trySee">
						<text v-if="buyInfo.isTry>0 && buyInfo.isTry<buyInfo.tryTime" @click="goRoom(buyInfo.id, 500)">继续试看{{buyInfo.tryTime - buyInfo.isTry}}分钟</text>
