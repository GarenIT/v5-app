	...
	<view class="login" :style="{'padding-top':top+'px'}">
		...
		<view v-if="isLoginStatus==1">
			...
			<view class="btn-right" @click="setLoingStatus(2)">
				<uni-icons type="contact-filled" color="#ffffff" size="28" style="margin-top:150upx;display:block;"></uni-icons>
		...
		<view v-if="isLoginStatus==2">
			<view class="login-content-right" :style="{'height':hMobileCode+'upx'}">
				...
				<view class="footer">
					...
					<!-- 协议地址 -->
					<view>
						<text style="color:#ccc;" @click="skipUrl('/pages/member/activity?type=agreement')">《服务协议》</text>和
			...
			<view class="btn-left" @click="setLoingStatus(1)" :style="{'height':(hMobileCode+60)+'upx'}">
				<uni-icons type="contact" color="#ffffff" size="28" style="margin-top:150upx;display:block;" :style="{'margin-top':backTop+'upx'}"></uni-icons>
