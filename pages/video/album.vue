<template>
	<view class="bg">
		...
		<view style="padding:15px 5% 10px;width:90%;">
			...
			<view style="padding:5px;margin-top:14upx;border-radius:5px;font-size:28upx;color:#CCCCCC;line-height:40upx;">
		...
		getAlbum() {
			uni.request({
				...
				success: (e)=> {
					...
					if(_self.albumInfo.Introduction.length < 1) _self.albumInfo.Introduction = '此人很懒，暂无简介。';
