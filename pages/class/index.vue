<template>
    <view>
		<view class="mask" 
			v-if="loading" 
			style="background-color:#20202C;z-index:10!important;margin-top: var(--status-bar-height)" 
			:style="{'height':(phone.screenHeight+h5)+'px'}"
			@touchmove.stop.prevent="moveHandle">
			<view class="loading13" style="margin-top:-120upx;">
				<view></view>
				<view></view>
				<view></view>
				<view></view>
		...
		<view class="class-list">
			...
			<view class="video-class" v-for="(item, index) in classData" :key="index">
