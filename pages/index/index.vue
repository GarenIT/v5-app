<template>
  <view class="page">
    ...
    <!-- 公告弹窗 -->
    <uni-popup ref="popupNotice" type="center" backColor="rgba(0,0,0,0.8)" v-if="false">
    ...
    <!-- 评论列表 -->
    <uni-popup ref="popupComment" type="bottom" @change="commentChange" v-if="false">
