	...
	<view class="bg" :style="{ height: bgHeight + 'px'}">
		...
		<view class="bank-list">
			<view class="bank-info">
				<button type="default" @click="showSinglePicker" style="width:90%;background:#FFFFFF;">{{pickerText}}</button>
			</view>
			<view class="bank-info">
...
.bank-img{ width:80px;height:80px;float:right;top:20px;right:10px;opacity:0.5;filter:alpha(opacity=50); }
.bank-list{ 
	width:68%;
	font-size:16px;
	margin:0 auto;
...
.bank-list view{ display: inline-block; }
.bank-info{ width: 100%; }
.bank-info input{
