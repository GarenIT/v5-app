<template>
	<view class="bg">
		<view class="mask" v-if="loading" style="background-color:#1D1D28;margin-top:0!important;" :style="{'height':loadHeight+'px'}">
			<view class="loading13" style="position:absolute;">
				<view></view>
				<view></view>
				<view></view>
				<view></view>
...
export default {
	...
	methods: {
		...
		saveShareImg() {
			...
			// #endif
			// #ifdef APP-PLUS
			uni.showLoading({ title:'正在保存海报...',mask:true });
...
@import url('@/components/loading/loading.css');
	...
	.poster{ width:100%;padding:0;margin:0;position:fixed;top:0; }
	.poster-bg{ background:#FFFFFF; }
</style>
