	...
	<view class="bg" :style="{ height: bgHeight + 'px' }">
		<view class="head">
			<view class="head-money">
				<view><image src="@/static/imgs/today.png" mode="aspectFill"></image></view>
				<view>今日安装</view>
				<view class="head-wz">{{info.today}}人</view>
			</view>
			<view class="head-money">
				<view><image src="@/static/imgs/all.png" mode="aspectFill"></image></view>
				<view>累计安装</view>
		...
		<view class="content">
			<view class="content-list" v-for="(s, i) in info.list" :key="i">
				<image class="content-tx" :src="(i%2)?'../../static/imgs/tx1.png':'../../static/imgs/tx0.png'" mode="aspectFill"></image>
...
<style>
.content-list{ width:90%;;height:40px;margin:0 5%;margin-top:10px;font-size:14px;color:#666666;line-height:40px;border-bottom:1px dashed #E2E2E2; }
.content-tx{ width:26px;height:26px;float:left;margin-top:7px; }
.content-time{ margin-left:15px; }
.content-point{ float:right;color:#009688;font-size:12px; }
.footer{ width:100%;font-size:16px;text-align:center;margin-top:6%;color:#666666; }
.bg{ 
	width: 100%;
	height: 690px;
	background: #ffffff;
...
.head-money view{ display: block;width: 100%;font-size: 18px; }
.head-money image{ width: 50px;height: 50px;margin-top: 70px; }
.head-money .head-wz{ 
...
.content{ 
	width: 90%;
	border-radius: 10px;
	background: #FFFFFF;margin: -50px auto 0;
...
.content-gt{ width: 35%;margin: 20px 0 0 10%;text-align: center;padding: 10px 0;border-radius: 10px;color: #666666; }
.content-gt image{ width: 40px;height: 40px; }
