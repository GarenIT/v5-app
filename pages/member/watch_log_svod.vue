	...
	<view class="bg">
		...
		<view class="watch-list">
			...
			<view style="width:100%;margin-top:200px;text-align:center;" v-if="isShowTig">
				...
				<view style="width:100%;font-size:25upx;color:#999;margin-top:30upx;">暂无短视频购买记录</view>
			</view>
...
.cover{ width:100%;height:100%;border-radius:10px;box-shadow: 0px 4px 6px 0px rgba(0, 0, 0, 0.5); }
.cover >>> .origin-img{
	border-radius: 10px;
}
