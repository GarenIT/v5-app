	...
	<view class="bg">
		...
		<view class="bank-list" :style="{'margin-top': (top+13) + 'px'}">
			<view :class="l.status>0?'bank-info ok':'bank-info no'" v-for="(l, i) in logList" :key="i">
				<view class="img"><image :src="l.banklogo" mode="aspectFill"></image></view>
...
.bank-list{ margin-top:70px;padding-bottom:15px; }
.bank-info view{ display: inline-block; }
.bank-info .img{
	width: 20%;
}
.bank-info .img image{
...
.bank-content view{ display: block; }
